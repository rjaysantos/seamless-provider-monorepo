...
use Providers\Jdb\JdbController;
...
class JdbControllerTest extends TestCase
{
    ...
    public function test_play_stubServiceInvalidBearerToken_invalidBearerTokenExceptin()
    {
    ...
    public function test_visual_stubServiceInvalidBearerToken_invalidBearerTokenException()
    {
        $this->expectException(InvalidBearerTokenException::class);
    ...
    public function test_entrypoint_stubEncryptionNullAction_invalidProviderRequestException()
    {
        $this->expectException(InvalidProviderRequestException::class);
    ...
    public function test_cancelBetAndSettle_mockService_cancelBetAndSettle()
    {
        ...
        $controller = $this->makeController(encryption: $stubEncryption, service: $mockService);
        $controller->entryPoint(request: $request, currency: 'IDR');
    }
    ...
    public function test_bet_stubResponse_expected()
    {
        ...
        $controller = $this->makeController(encryption: $stubEncryption, response: $stubResponse);
        $response = $controller->entryPoint(request: $request, currency: 'IDR');
