...
class JdbServiceTest extends TestCase
{
    ...
    public function test_cancelBetAndSettle_stubRepositoryNullTransaction_transactionStillProcessingException()
    {
        $this->expectException(TransactionStillProcessingException::class);
    ...
    public function test_cancelBetAndSettle_stubRepositoryTransactionNotNull_transactionAlreadySettledException()
    {
