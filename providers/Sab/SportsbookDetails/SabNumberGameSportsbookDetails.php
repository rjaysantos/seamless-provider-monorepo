...
class SabNumberGameSportsbookDetails implements ISabSportsbookDetails
{
    public function __construct(protected object $sabSportsbookDetails, private string $ipAddress) {}

    public function getGameCode(): string
    {
        if ($this->sabSportsbookDetails->sport_type == 161 || $this->sabSportsbookDetails->sport_type == 164)
            $gameCode = 'Number Game';
