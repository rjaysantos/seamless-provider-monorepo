...
class Hg5ControllerTest extends TestCase
{
    ...
    public function test_multipleWithdraw_missingRequestParameter_invalidProviderRequestException($parameter)
    {
        $this->expectException(InvalidProviderRequestException::class);
        ...
        $controller = $this->makeController();
        $controller->multipleWithdraw(request: $request);
    }

    #[DataProvider('multipleWithdrawParams')]
    public function test_multipleWithdraw_invalidRequestType_invalidProviderRequestException($parameter, $data)
    {
        $this->expectException(InvalidProviderRequestException::class);
    ...
    public function test_multipleWithdraw_mockService_multipleBet()
    {
        $request = new Request([
            'datas' => [
                (object) [
    ...
    public function test_multipleWithdraw_mockResponse_multipleWithdraw()
    {
        $request = new Request([
            'datas' => [
                [
        ...
        $stubService = $this->createMock(Hg5Service::class);
        $stubService->method('multipleBet')
            ->willReturn([]);
    ...
    public function test_multipleWithdraw_stubResponse_expectedData()
    {
        $expectedData = new JsonResponse;
        ...
        $controller = $this->makeController(response: $stubResponse);
        $response = $controller->multipleWithdraw(request: $request);
