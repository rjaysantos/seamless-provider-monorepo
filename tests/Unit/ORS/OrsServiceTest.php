...
use App\GameProviders\V2\ORS\OrsApi;
use Wallet\V1\ProvSys\Transfer\Report;
use App\GameProviders\V2\ORS\OrsService;
use App\GameProviders\V2\ORS\OgSignature;
use App\Libraries\Wallet\V2\WalletReport;
use App\GameProviders\V2\ORS\OrsRepository;
use App\GameProviders\V2\ORS\OrsCredentials;
use App\GameProviders\V2\ORS\Contracts\ICredentials;
use App\GameProviders\V2\ORS\Exceptions\WalletErrorException;
use App\GameProviders\V2\ORS\Exceptions\InvalidTokenException;
use App\GameProviders\V2\ORS\Exceptions\InsufficientFundException;
use App\GameProviders\V2\ORS\Exceptions\InvalidPublicKeyException;
use App\GameProviders\V2\ORS\Exceptions\TransactionAlreadyExistsException;
...
use App\GameProviders\V2\ORS\Exceptions\PlayerNotFoundException as ProviderPlayerNotFoundException;
use App\GameProviders\V2\ORS\Exceptions\TransactionNotFoundException as ProviderTransactionNotFoundException;
