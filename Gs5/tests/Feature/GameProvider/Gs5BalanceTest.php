...
class Gs5BalanceTest extends TestCase
{
    ...
    public function test_balance_validRequest_expectedData()
    {
        ...
        $response = $this->get(uri: 'gs5/prov/api/getbalance/?' . http_build_query($request));
    ...
    public function test_balance_invalidRequest_expectedData()
    {
        $request = [];
    ...
    public function test_balance_tokenNotFound_expectedData()
    {
        DB::table('gs5.players')->insert([
            'play_id' => 'testPlayID',
            'username' => 'testUsername',
    ...
    public function test_balance_walletError_expectedData()
    {
        $wallet = new class extends TestWallet {
            public function balance(IWalletCredentials $credentials, string $playID): array
            {
