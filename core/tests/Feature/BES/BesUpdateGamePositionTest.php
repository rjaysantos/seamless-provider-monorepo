...
{
    public function test_updateGamePosition_validData_successReturn()
    {
        Http::fake([
    ...
    public function test_updateGamePosition_validDataDifferentSorting_successReturn()
    {
        Http::fake([
            '/api/game/subgamelist' => Http::response(json_encode([
                'gamelist' => [
    ...
    public function test_updateGamePosition_updateGamePositionApiFailed_thirdPartyException()
    {
        Http::fake([
            '/api/game/subgamelist' => Http::response(json_encode([
                'gamelist' => [
