...
class Cq9CreditTest extends TestCase
{
    ...
    public function test_credit_validRequest_expectedData()
    {
        ...
        $request = [
            'account' => 'testPlayID',
            'eventTime' => '2021-01-02T00:00:00.00-04:00',
            'gamecode' => 'testPlayID',
        ...
        $response = $this->post('/cq9/prov/transaction/game/credit', $request, [
        ...
        $this->assertDatabaseHas('cq9.reports', [
            ...
            'updated_at' => '2021-01-02 12:00:00'
        ]);

        Carbon::setTestNow();
    }

    public function test_credit_invalidEventTime_expectedData()
    {
        Cq9Player::factory()->create([
            'play_id' => 'testPlayID',
            'currency' => 'IDR',
    ...
    public function test_credit_transactionAlreadyExist_expectedData()
    {
        Carbon::setTestNow('2021-01-01 12:00:00');
     ...
     */
    public function test_credit_incompleteRequestParameters_expectedData($params)
    {
        Carbon::setTestNow('2021-01-01 12:00:00');
