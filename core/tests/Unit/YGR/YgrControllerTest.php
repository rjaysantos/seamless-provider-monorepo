...
use App\GameProviders\V2\Ygr\YgrController;
...
use App\GameProviders\V2\Ygr\Exceptions\InvalidProviderRequestException;
...
class YgrControllerTest extends TestCase
{
    private function makeController(
        ...
        $casinoService ??= $this->createStub(YgrCasinoService::class);
        $providerService ??= $this->createStub(YgrProviderService::class);
    ...
    public function test_play_mockCasinoService_getLaunchUrl()
    {
        ...
        $mockCasinoService = $this->createMock(YgrCasinoService::class);
        $mockCasinoService->expects($this->once())
            ->method('getLaunchUrl')
            ->with($request);

        $controller = $this->makeController(casinoService: $mockCasinoService);
        $controller->play(request: $request);
    }
    ...
    public function test_play_mockResponse_casinoSuccess()
    {
        ...
        $stubService = $this->createMock(YgrCasinoService::class);
    ...
    public function test_verifyToken_mockProviderService_getPlayerDetails()
    {
        ...
        $mockProviderService = $this->createMock(YgrProviderService::class);
    ...
    public function test_verifyToken_mockResponse_verifyToken()
    {
        ...
        $stubProviderService = $this->createMock(YgrProviderService::class);
