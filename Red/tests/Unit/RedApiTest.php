...
class RedApiTest extends TestCase
{
    ...
    public function test_authenticate_mockHttp_post()
    {
        ...
        $credentials->method('getPrdID')->willReturn(111);
        $credentials->method('getApiUrl')->willReturn('testApiUrl.com');
        $credentials->method('getCode')->willReturn('testCode');
        $credentials->method('getToken')->willReturn('testToken');
    ...
    public function test_getBetDetailUrl_mockHttp_post()
    {
        ...
        $credentials->method('getApiUrl')->willReturn('testApiUrl.com');
        $credentials->method('getPrdID')->willReturn(213);
        $credentials->method('getCode')->willReturn('testCode');
        $credentials->method('getToken')->willReturn('testToken');
